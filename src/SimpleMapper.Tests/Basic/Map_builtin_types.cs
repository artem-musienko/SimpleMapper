...
{
    public class Map_builtin_types
    {
        public const int MAX = 100;
        public const double TOLERANCE = 0.000001;

        [Test]
        public void Map_from_byte()
        {
            ...
            ((byte)MAX.Random()).TestMapper<byte, float>((a, b) => 0 == b.CompareTo(a), "Byte mapping");
            ((byte)MAX.Random()).TestMapper<byte, double>((a, b) => 0 == b.CompareTo(a), "Byte mapping");
            ((byte)MAX.Random()).TestMapper<byte, char>((a, b) => a == b, "Byte mapping");
        }

        [Test]
        public void Map_from_sbyte()
        {
            ...
            ((sbyte)MAX.Random()).TestMapper<sbyte, float>((a, b) => 0 == b.CompareTo(a), "Sbyte mapping");
            ((sbyte)MAX.Random()).TestMapper<sbyte, double>((a, b) => 0 == b.CompareTo(a), "Sbyte mapping");
            ((sbyte)MAX.Random()).TestMapper<sbyte, char>((a, b) => a == b, "Sbyte mapping");
        }

        [Test]
        public void Map_from_int16()
        {
            ...
            ((short)MAX.Random()).TestMapper<short, float>((a, b) => 0 == b.CompareTo(a), "Int16 mapping");
            ((short)MAX.Random()).TestMapper<short, double>((a, b) => 0 == b.CompareTo(a), "Int16 mapping");
            ((short)MAX.Random()).TestMapper<short, char>((a, b) => a == b, "Int16 mapping");
        }

        [Test]
        public void Map_from_char()
        {
            ...
            ((char)MAX.Random()).TestMapper<char, float>((a, b) => 0 == b.CompareTo(a), "Char mapping");
            ((char)MAX.Random()).TestMapper<char, double>((a, b) => 0 == b.CompareTo(a), "Char mapping");
            ((char)MAX.Random()).TestMapper<char, char>((a, b) => a == b, "Char mapping");
        }

        [Test]
        public void Map_from_decimal()
        {
        ...
        [Test]
        public void Map_from_double()
        {
            ((double)MAX.Random()).TestMapper<double, byte>((a, b) => Math.Abs(a - b) < TOLERANCE, "Double mapping");
            ((double)MAX.Random()).TestMapper<double, sbyte>((a, b) => Math.Abs(a - b) < TOLERANCE, "Double mapping");
            ((double)MAX.Random()).TestMapper<double, short>((a, b) => Math.Abs(a - b) < TOLERANCE, "Double mapping");
            ((double)MAX.Random()).TestMapper<double, ushort>((a, b) => Math.Abs(a - b) < TOLERANCE, "Double mapping");
            ((double)MAX.Random()).TestMapper<double, int>((a, b) => Math.Abs(a - b) < TOLERANCE, "Double mapping");
            ((double)MAX.Random()).TestMapper<double, uint>((a, b) => Math.Abs(a - b) < TOLERANCE, "Double mapping");
            ((double)MAX.Random()).TestMapper<double, long>((a, b) => Math.Abs(a - b) < TOLERANCE, "Double mapping");
            ((double)MAX.Random()).TestMapper<double, ulong>((a, b) => Math.Abs(a - b) < TOLERANCE, "Double mapping");
            ((double)MAX.Random()).TestMapper<double, decimal>((a, b) => Math.Abs(a - (double) b) < TOLERANCE, "Double mapping");
            ((double)MAX.Random()).TestMapper<double, float>((a, b) => Math.Abs(a - b) < TOLERANCE, "Double mapping");
            ((double)MAX.Random()).TestMapper<double, double>((a, b) => Math.Abs(a - b) < TOLERANCE, "Double mapping");
            ((double)MAX.Random()).TestMapper<double, char>((a, b) => Math.Abs(a - b) < TOLERANCE, "Double mapping");
        }

        [Test]
        public void Map_from_float()
        {
            ((float)MAX.Random()).TestMapper<float, byte>((a, b) => Math.Abs(a - b) < TOLERANCE, "Float mapping");
            ((float)MAX.Random()).TestMapper<float, sbyte>((a, b) => Math.Abs(a - b) < TOLERANCE, "Float mapping");
            ((float)MAX.Random()).TestMapper<float, short>((a, b) => Math.Abs(a - b) < TOLERANCE, "Float mapping");
            ((float)MAX.Random()).TestMapper<float, ushort>((a, b) => Math.Abs(a - b) < TOLERANCE, "Float mapping");
            ((float)MAX.Random()).TestMapper<float, int>((a, b) => Math.Abs(a - b) < TOLERANCE, "Float mapping");
            ((float)MAX.Random()).TestMapper<float, uint>((a, b) => Math.Abs(a - b) < TOLERANCE, "Float mapping");
            ((float)MAX.Random()).TestMapper<float, long>((a, b) => Math.Abs(a - b) < TOLERANCE, "Float mapping");
            ((float)MAX.Random()).TestMapper<float, ulong>((a, b) => Math.Abs(a - b) < TOLERANCE, "Float mapping");
            ((float)MAX.Random()).TestMapper<float, decimal>((a, b) => Math.Abs(a - (float)b) < TOLERANCE, "Float mapping");
            ((float)MAX.Random()).TestMapper<float, float>((a, b) => 0 == b.CompareTo(a), "Float mapping");
            ((float)MAX.Random()).TestMapper<float, double>((a, b) => 0 == b.CompareTo(a), "Float mapping");
            ((float)MAX.Random()).TestMapper<float, char>((a, b) => Math.Abs(a - b) < TOLERANCE, "Float mapping");
        }

        [Test]
        public void Map_from_int32()
        {
            ...
            ((int)MAX.Random()).TestMapper<int, float>((a, b) => 0 == b.CompareTo(a), "Int32 mapping");
            ((int)MAX.Random()).TestMapper<int, double>((a, b) => 0 == b.CompareTo(a), "Int32 mapping");
            ((int)MAX.Random()).TestMapper<int, char>((a, b) => a == b, "Int32 mapping");
        }

        [Test]
        public void Map_from_uint32()
        {
            ...
            ((uint)MAX.Random()).TestMapper<uint, float>((a, b) => 0 == b.CompareTo(a), "UInt32 mapping");
            ((uint)MAX.Random()).TestMapper<uint, double>((a, b) => 0 == b.CompareTo(a), "UInt32 mapping");
            ((uint)MAX.Random()).TestMapper<uint, char>((a, b) => a == b, "UInt32 mapping");
        }

        [Test]
        public void Map_from_int64()
        {
            ...
            ((long)MAX.Random()).TestMapper<long, float>((a, b) => 0 == b.CompareTo(a), "Int64 mapping");
            ((long)MAX.Random()).TestMapper<long, double>((a, b) => 0 == b.CompareTo(a), "Int64 mapping");
            ((long)MAX.Random()).TestMapper<long, char>((a, b) => a == b, "Int64 mapping");
        }

        [Test]
        public void Map_from_uint64()
        {
            ...
            ((ulong)MAX.Random()).TestMapper<ulong, float>((a, b) => 0 == b.CompareTo(a), "UInt62 mapping");
            ((ulong)MAX.Random()).TestMapper<ulong, double>((a, b) => 0 == b.CompareTo(a), "UInt62 mapping");
