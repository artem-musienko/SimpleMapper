...
namespace SimpleMapper.Tests
{
    ...
    public class Mapping_numeric_to_nullable
    {
        ...
        public void Byte()
        {
            ...
            ((byte)MAX.Random()).TestMapper<byte, float?>((a, b) => 0 == a.CompareTo((byte)b), "Byte mapping");
            ((byte)MAX.Random()).TestMapper<byte, double?>((a, b) => 0 == a.CompareTo((byte)b), "Byte mapping");
        ...
        public void Sbyte()
        {
            ...
            ((sbyte)MAX.Random()).TestMapper<sbyte, float?>((a, b) => 0 == a.CompareTo((sbyte)b), "Sbyte mapping");
            ((sbyte)MAX.Random()).TestMapper<sbyte, double?>((a, b) => 0 == a.CompareTo((sbyte)b), "Sbyte mapping");
        ...
        public void Int16()
        {
            ...
            ((short)MAX.Random()).TestMapper<short, float?>((a, b) => 0 == a.CompareTo((short)b), "Int16 mapping");
            ((short)MAX.Random()).TestMapper<short, double?>((a, b) => 0 == a.CompareTo((short)b), "Int16 mapping");
        ...
        public void Char()
        {
            ...
            ((char)MAX.Random()).TestMapper<char, float?>((a, b) => 0 == a.CompareTo((char)b), "Char mapping");
            ((char)MAX.Random()).TestMapper<char, double?>((a, b) => 0 == a.CompareTo((char)b), "Char mapping");
        ...
        public void Double()
        {
            ((double)MAX.Random()).TestMapper<double, byte?>((a, b) => Math.Abs(a - (double)b) < TOLERANCE, "Double mapping");
            ((double)MAX.Random()).TestMapper<double, sbyte?>((a, b) => Math.Abs(a - (double)b) < TOLERANCE, "Double mapping");
            ((double)MAX.Random()).TestMapper<double, short?>((a, b) => Math.Abs(a - (double)b) < TOLERANCE, "Double mapping");
            ((double)MAX.Random()).TestMapper<double, ushort?>((a, b) => Math.Abs(a - (double)b) < TOLERANCE, "Double mapping");
            ((double)MAX.Random()).TestMapper<double, int?>((a, b) => Math.Abs(a - (double)b) < TOLERANCE, "Double mapping");
            ((double)MAX.Random()).TestMapper<double, uint?>((a, b) => Math.Abs(a - (double)b) < TOLERANCE, "Double mapping");
            ((double)MAX.Random()).TestMapper<double, long?>((a, b) => Math.Abs(a - (double)b) < TOLERANCE, "Double mapping");
            ((double)MAX.Random()).TestMapper<double, ulong?>((a, b) => Math.Abs(a - (double)b) < TOLERANCE, "Double mapping");
            ((double)MAX.Random()).TestMapper<double, decimal?>((a, b) => Math.Abs(a - (double)b) < TOLERANCE, "Double mapping");
            ((double)MAX.Random()).TestMapper<double, float?>((a, b) => Math.Abs(a - (double)b) < TOLERANCE, "Double mapping");
            ((double)MAX.Random()).TestMapper<double, double?>((a, b) => Math.Abs(a - (double)b) < TOLERANCE, "Double mapping");
            ((double)MAX.Random()).TestMapper<double, char?>((a, b) => Math.Abs(a - (double)b) < TOLERANCE, "Double mapping");
        }

        [Test]
        public void Float()
        {
            ((float)MAX.Random()).TestMapper<float, byte?>((a, b) => Math.Abs(a - (float)b) < TOLERANCE, "Float mapping");
            ((float)MAX.Random()).TestMapper<float, sbyte?>((a, b) => Math.Abs(a - (float)b) < TOLERANCE, "Float mapping");
            ((float)MAX.Random()).TestMapper<float, short?>((a, b) => Math.Abs(a - (float)b) < TOLERANCE, "Float mapping");
            ((float)MAX.Random()).TestMapper<float, ushort?>((a, b) => Math.Abs(a - (float)b) < TOLERANCE, "Float mapping");
            ((float)MAX.Random()).TestMapper<float, int?>((a, b) => Math.Abs(a - (float)b) < TOLERANCE, "Float mapping");
            ((float)MAX.Random()).TestMapper<float, uint?>((a, b) => Math.Abs(a - (float)b) < TOLERANCE, "Float mapping");
            ((float)MAX.Random()).TestMapper<float, long?>((a, b) => Math.Abs(a - (float)b) < TOLERANCE, "Float mapping");
            ((float)MAX.Random()).TestMapper<float, ulong?>((a, b) => Math.Abs(a - (float)b) < TOLERANCE, "Float mapping");
            ((float)MAX.Random()).TestMapper<float, decimal?>((a, b) => Math.Abs(a - (float)b) < TOLERANCE, "Float mapping");
            ((float)MAX.Random()).TestMapper<float, float?>((a, b) => 0 == a.CompareTo((float)b), "Float mapping");
            ((float)MAX.Random()).TestMapper<float, double?>((a, b) => 0 == a.CompareTo((float)b), "Float mapping");
            ((float)MAX.Random()).TestMapper<float, char?>((a, b) => Math.Abs(a - (float)b) < TOLERANCE, "Float mapping");
        }
        ...
        public void Int32()
        {
            ...
            ((int)MAX.Random()).TestMapper<int, float?>((a, b) => 0 == a.CompareTo((int)b), "Int32 mapping");
            ((int)MAX.Random()).TestMapper<int, double?>((a, b) => 0 == a.CompareTo((int)b), "Int32 mapping");
        ...
        public void UInt32()
        {
            ...
            ((uint)MAX.Random()).TestMapper<uint, float?>((a, b) => 0 == a.CompareTo((uint)b), "UInt32 mapping");
            ((uint)MAX.Random()).TestMapper<uint, double?>((a, b) => 0 == a.CompareTo((uint)b), "UInt32 mapping");
        ...
        public void Int64()
        {
            ...
            ((long)MAX.Random()).TestMapper<long, float?>((a, b) => 0 == a.CompareTo((long)b), "Int64 mapping");
            ((long)MAX.Random()).TestMapper<long, double?>((a, b) => 0 == a.CompareTo((long)b), "Int64 mapping");
        ...
        public void UInt64()
        {
            ...
            ((ulong)MAX.Random()).TestMapper<ulong, float?>((a, b) => 0 == a.CompareTo((ulong)b), "UInt62 mapping");
            ((ulong)MAX.Random()).TestMapper<ulong, double?>((a, b) => 0 == a.CompareTo((ulong)b), "UInt62 mapping");
